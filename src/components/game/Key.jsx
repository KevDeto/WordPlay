    ...
    return (
        <button
            ...
            className={`
                ...
                font-bold text-[10px] xs:text-[14px] sm:text-lg md:text-[23px] ${getColorState()}
                ...
                ${label === "ENTER" || label === "BACKSPACE" 
                    ...
                    : "w-[28px] h-[30px] xs:w-[40px] xs:h-[40px] sm:w-[52px] sm:h-[52px] md:w-[64px] md:h-[64px]" }
                `}
        >
